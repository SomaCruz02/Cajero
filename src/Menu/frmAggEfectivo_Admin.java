 ...
 * @author mario
 */
public class frmAggEfectivo_Admin extends javax.swing.JFrame {
    ...
    public void Alerta(int i){
        if(E){
            if (i == 0){
                JOptionPane.showMessageDialog(null, "Distribución Errónea");
            }else{
                JOptionPane.showMessageDialog(null, "El límite por operación es de Q30,0000");
            }
        }else{
            Crear();
            JOptionPane.showMessageDialog(null, "SALDO AGREGADO EXITOSAMENTES", "SALDO", HEIGHT);
            
            frmMenu_Administrador w = new frmMenu_Administrador();
    ...
    private void Crear(){
        ...
        try{    
            ...
            crear.format("%s\r\n%s\r\n%s\r\n%s\r\n%s\r\n%s\r\n%s\r\n%s",
                    ...
                    "B200="+(Integer.parseInt(Q200.getValue().toString())+a.get(0).Q200),
                    "B100="+(Integer.parseInt(Q100.getValue().toString())+a.get(0).Q100),
                    "B50="+(Integer.parseInt(Q50.getValue().toString())+a.get(0).Q50),
                    "B20="+(Integer.parseInt(Q20.getValue().toString())+a.get(0).Q20),
                    "B10="+(Integer.parseInt(Q10.getValue().toString())+a.get(0).Q10),
                    "B5="+(Integer.parseInt(Q5.getValue().toString())+a.get(0).Q5),
                    "B1="+(Integer.parseInt(Q1.getValue().toString())+a.get(0).Q1));
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingrese la cantidad del lote de billetes a ingresar");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(Alerta, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(17, 17, 17))
        );
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(Alerta, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(4, 4, 4)
    ...
    private void IngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IngresarActionPerformed
        int TE = 0;
        if(Integer.parseInt(Saldo.getValue().toString())>30000){
            E = true;
            TE = 1;
        }
       Alerta(TE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAggEfectivo_Admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmAggEfectivo_Admin().setVisible(true);
            }
        });
    }
